...
"""autogenerated by genpy from instance_segmentation_depth/DetectionRequest.msg. Do not edit."""
import codecs
import sys
...
class DetectionRequest(genpy.Message):
  ...
  _type = "instance_segmentation_depth/DetectionRequest"
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from instance_segmentation_depth/DetectionResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
import instance_segmentation_depth.msg
import sensor_msgs.msg
import std_msgs.msg

class DetectionResponse(genpy.Message):
  _md5sum = "64d459114129c709608ffbe0be02bb47"
  _type = "instance_segmentation_depth/DetectionResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """Result detection_result
...
uint8[] data          # actual matrix data, size is (step * rows)
"""
  __slots__ = ['detection_result']
  _slot_types = ['instance_segmentation_depth/Result']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.detection_result is None:
        self.detection_result = instance_segmentation_depth.msg.Result()
    else:
      self.detection_result = instance_segmentation_depth.msg.Result()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3I().pack(_x.detection_result.header.seq, _x.detection_result.header.stamp.secs, _x.detection_result.header.stamp.nsecs))
      _x = self.detection_result.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.detection_result.class_names)
      buff.write(_struct_I.pack(length))
      for val1 in self.detection_result.class_names:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      length = len(self.detection_result.masks)
      buff.write(_struct_I.pack(length))
      for val1 in self.detection_result.masks:
        _v1 = val1.header
        _x = _v1.seq
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.detection_result.header.seq, _x.detection_result.header.stamp.secs, _x.detection_result.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.detection_result.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.detection_result.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.detection_result.class_names = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.detection_result.class_names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.detection_result.masks = []
      for i in range(0, length):
        ...
        self.detection_result.masks.append(val1)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
class Detection(object):
  _type          = 'instance_segmentation_depth/Detection'
  _md5sum = '89253a697464e24247a71577fdb0df85'
