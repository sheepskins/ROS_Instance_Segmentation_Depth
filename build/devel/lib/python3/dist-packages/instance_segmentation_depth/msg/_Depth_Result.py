...
"""autogenerated by genpy from instance_segmentation_depth/Depth_Result.msg. Do not edit."""
import codecs
import sys
...
class Depth_Result(genpy.Message):
  _md5sum = "8c769a6dc22d14b3306fcf937008cfe3"
  _type = "instance_segmentation_depth/Depth_Result"
...
string frame_id
"""
  __slots__ = ['header','class_names','depths','size']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,class_names,depths,size
    ...
    """
    if args or kwds:
      super(Depth_Result, self).__init__(*args, **kwds)
